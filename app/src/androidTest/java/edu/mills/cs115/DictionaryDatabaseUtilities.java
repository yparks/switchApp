 ...
 * @author barango
 */
class DictionaryDatabaseUtilities extends SQLiteOpenHelper {
    private static final String TAG = "DicDatabaseUtilities";
    ...
    private static long loadTermsLong;
     ...
     */
    DictionaryDatabaseUtilities(Context context) {
     ...
     */
    public static long addTerm(String term, String definition, String category) {
